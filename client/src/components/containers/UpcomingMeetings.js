...
const mapDispatchToProps = (dispatch) => ({
  loadMeetings: (meetings) => dispatch({ type: 'LOAD_UPCOMING_MEETINGS_LIST', payload: meetings })
});

export default connect(mapStateToProps, mapDispatchToProps)(UpcomingMeetings);
